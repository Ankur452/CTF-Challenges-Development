...
def welcome():
    ...
    resp.set_cookie('is_cookie_provided','True', max_age=60*60*24*365*2, secure='True', httponly='True')
    ...
    resp.set_cookie('is_mouse','True', max_age=60*60*24*365*2, secure='True', httponly='True')
    resp.set_cookie('to_mouse','False', max_age=60*60*24*365*2, secure='True', httponly='True')
    ...
    resp.set_cookie('uid-vii','ajdhewiuy98hij43bjmv39h983hu843g793bv9kn34y84g8gb483ut32g3bjy983hfyfew79gsdlkjfoiwf98732dshf82r9whef98u2fih28fo29ub349th48743g83qh4gy983hfyfew79gsdlkjfoiwf98732dshf82r9whef98u2fih28fo29ub349th438h3', max_age=60*60*24*365*2)
    ...
    resp.set_cookie('switch-user','True', max_age=60*60*24*365*2)
...
@app.route('/ius34fh2siudafh98743', methods=['POST'])
def flag():
